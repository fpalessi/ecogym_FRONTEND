...
const RegisterPage = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const fullName = (event.currentTarget.elements[0] as HTMLInputElement)
      .value;
    ...
    if ([fullName, email, password].includes("")) {
      setAlert("Por favor, rellena todos los campos para registrarte");
      return;
    }
    if (fullName.length < 3) {
      setAlert("El nombre completo debe tener al menos 3 caracteres");
      return;
    }
    ...
    try {
      ...
      setAlert("Lo sentimos, pero ese correo se encuentra en uso");
    }
  };
  return (
    <form
      className="min-w-screen flex min-h-screen items-center justify-center bg-gray-70 px-5 py-5"
      onSubmit={handleSubmit}
    >
      <div
        className="w-full overflow-hidden rounded-3xl bg-gray-100 text-gray-50 shadow-xl"
        style={{ maxWidth: "1000px" }}
      >
        <div className="w-full md:flex">
          <div className="hidden w-1/2 bg-yellow-50 py-10 px-10 md:block">
            <svg
          ...
          <div className="w-full py-10 px-5 md:w-1/2 md:px-10">
            <div className="mb-10 text-center">
              ...
              <p>
                Regístrate para acceder a la tienda de productos propios
                ecológicos
              </p>
            </div>
            <div>
                ...
                <div className="mb-4 w-full px-3">
                  ...
                  <div className="flex">
                    ...
                    <input
                      type="text"
                      id="full-name"
                      className="-ml-10 w-full rounded-lg border-2 border-gray-200 py-2 pl-10 pr-3 outline-none focus:border-gray-700"
                      placeholder="Mariano Rajoy"
                    />
                  </div>
                </div>
              </div>
              <div className="-mx-3 flex">
                <div className="mb-4 w-full px-3">
                  <label htmlFor="email" className="px-1 text-xs font-semibold">
                    Email
                  </label>
                  <div className="flex">
                    <div className="pointer-events-none z-10 flex w-10 items-center justify-center pl-1 text-center"></div>
                    <input
                      ...
                      id="email"
                      className="-ml-10 w-full rounded-lg border-2 border-gray-200 py-2 pl-10 pr-3 outline-none focus:border-gray-700"
                      placeholder="m.rajoy@hotmail.com"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="-mx-3 flex">
                <div className="mb-4 w-full px-3">
                  <button className="mx-auto mb-2 block w-full max-w-xs rounded-lg bg-primary-100 px-3 py-3 font-semibold text-white hover:bg-red-600">
                    REGISTARSE
                  </button>
                  {alert && (
